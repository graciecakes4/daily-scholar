...
export default function ActiveScopeChip() {
  ...
  if (state === 'loading' || state === 'error') {
    ...
    return <div className="mx-1.5 mb-5 h-[88px] shrink-0 rounded-[10px] bg-paper-2/60 border border-rule/60 animate-pulse" aria-hidden />;
  }
  ...
  if (state === 'empty') {
    return (
      <Link
        href="/scopes/picker"
        className="group relative mx-1.5 mb-5 shrink-0 block rounded-[10px] border border-rule bg-paper-2 px-3.5 pt-3 pb-3.5 hover:bg-paper-3 transition-colors"
      >
  ...
  return (
    <div className="relative mx-1.5 mb-5 shrink-0 overflow-hidden rounded-[10px] border border-rule px-3.5 py-3"
