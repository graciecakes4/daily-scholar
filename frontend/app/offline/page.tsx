    ...
    <div className="min-h-[60vh] flex items-center justify-center">
      <div className="max-w-md text-center space-y-4">
        ...
        <div className="flex flex-wrap justify-center gap-2 pt-2">
          <Link
            href="/"
            className="px-4 py-2 rounded-lg bg-gold-dark text-white text-sm font-medium hover:bg-[#734f14]"
          >
            Dashboard
          </Link>
          <Link
            href="/papers"
            className="px-4 py-2 rounded-lg bg-paper-2 border border-rule text-ink-2 text-sm font-medium hover:bg-paper"
          >
            Papers
          </Link>
          <Link
